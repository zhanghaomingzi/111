...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5s-linjian.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/linjian.yaml', help='data.yaml path')
